...
namespace Disassembler6510
{
	class cDis
	{
		unsafe static void dis(string[] args)
		{
			string[] argv = {""};
			if (!(args == null)) { argv = args; }
			...
			//FILE* file_ptr;
			char ch;
			FileStream file_ptr = new FileStream(argv[1], FileMode.Open);
			int iTest = 0;
			int iCount = 0;
			int iOperand16 = 0;
			int iOperand8 = 0;
			...
			while ((ch = (char)file_ptr.ReadByte()) != -1)
			{
				a++;
        ...
        private static void printf(string v1, int v2, string v3, string v4)
		{
			//.ToString();
throw new NotImplementedException();
		}
		private static void printf(string v1, string v2, string v3)
		{
			throw new NotImplementedException();
		}
		private static void printf(string v1, int v2, int v3, int v4)
		{
			throw new NotImplementedException();
		}
		private static void printf(string v1, int v2, int v3)
		{
			throw new NotImplementedException();
		}
		private static void printf(string v1, int v2)
        {
            throw new NotImplementedException();
        }
        private static void printf(string v, string v1)
        {
            throw new NotImplementedException();
        }

        private static unsafe void sscanf(string v1, string v2, int* v3)
		{
			switch (v2)
			{
				case "%d":
